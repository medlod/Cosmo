...
> ticket | covid | rank | leaderboard | github | ‎remind | poll | ‎suggest | magik | userinfo | eject | checkwarn | ping | infoinvite | serverinfo | ‎botinfo | ‎afk on | afk off | support
...
💳**Economy Commands**💳
> work | ‎bal | checkbal | crime | fish | gift | beg | shop | inv | slots | dep or deposit | with or withdraw‎ | daily | lb or leaderboard cash | lb or leaderboard bank |
...
📛**Bot Config Commands**📛
> setsuggest‎ | setmodlogs | setTicket | tc |
...
**NetWorth**
$$sum[$getVar[money;$authorID];$getVar[bank;$authorID]]]
$addTimestamp`
})
bot.Command({
    name: "/work",
...
$title[💰 - $username[$mentioned[1]] Cash]
$color[$random[11111;99999]]
$description[**Wallet**
$$getVar[money;$mentioned[1]]

**Bank**
$$getVar[bank;$mentioned[1]]

**NetWorth**
$$sum[$getVar[money;$mentioned[1]];$getVar[bank;$mentioned[1]]]]
$addTimestamp`
})
bot.Command({
    name: "/cuddle",
...
$onlyIf[$message[]!=;Please enter your suggestion!]`
})
bot.Command({
    name: "/setmodlogs",
...
bot.Command({
    name: "slots",
    code: `$setVar[money;$$randomText[sum;sub][$getVar[money;$authorID];$message[1]];$authorID]
$authorIcon[$authorAvatar]
$author[Slot machine 🎰]
$description[$replaceText[$replaceText[$randomText[sum;sub];sum;
...
You Lost] $$message[1]]
$footer[Your current balance is $$randomText[sum;sub][$getVar[money;$authorID];$message[1]]]
$argsCheck[<1;Incorrect usage! correct usage: -bet <number>]
$onlyIf[$getVar[money;$authorID]>=$message[1];You don't have enough money!]
$suppressErrors[Please supply a valid number!]
$color[$random[11111;99999]]`
})
bot.Command({
    name: "/inv",
...
bot.Command({
    name: "/crime",
    code: `$setVar[money;$sum[$getVar[money;$authorID];$random[400;1800]];$authorID]
$footer[You can commit crimes every 12h so make sure to check back in, $username[$authorID]]
$description[$randomText[You commit tax fraud!;You kidnapped a child!;You blackmailed the United Nations;You leaked nuclear launch codes!] and earned $$random[400;1800]💵]
$title[PAYOUT]
$color[$random[11111;99999]]
...
$setUserVar[req;$sum[$getUserVar[req];$random[200;300]]]
...
bot.SpaceCommand({
    name: "afk",
    code: `$description[<@$mentioned[1]> Is currently AFK!
AFK: $getUserVar[msg;$mentioned[1]]]
$color[$random[11111;99999]]
