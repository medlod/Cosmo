...
> covid | rank | leaderboard | github | ‎remind | profile | poll | ‎suggest | binary | base64 | userinfo | checkwarn | ping | infoinvite | serverinfo | ‎botinfo | ‎afk on | afk off | support
...
🎃**Staff Commands**🎃
> purge‎ | announce | nick | ban | mute | unmute‎ | warn | setslowmode | createrole‎ | checkwarn‎ | setwarns | banid‎ | unbanid‎ | kick‎ | role‎ | takerole‎ | createchannel | deletechannel |

📛**Bot Config Commands**📛
> setsuggest‎ | setmodlogs | setmutedrole | setwelcome | chatmode |
...
bot.SpaceCommand({
    name: "chatmode",
    code: `$api[https://some-random-api.ml/chatbot?message=$replaceText[$message[]; ;+];response]
